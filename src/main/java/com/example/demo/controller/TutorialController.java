...
public class TutorialController {
    ...
    public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String title){
        try {
            ...
            if (tutorials.isEmpty()) return new ResponseEntity<>(tutorials, HttpStatus.OK);
    ...
    public ResponseEntity<HttpStatus> deleteTutorial(@PathVariable("id") long id, @RequestBody Tutorial tutorial) {
        try{
